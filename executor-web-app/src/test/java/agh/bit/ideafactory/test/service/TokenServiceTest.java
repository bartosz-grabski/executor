...
/**
 * Created with IntelliJ IDEA. User: bgrabski Date: 26.05.13 Time: 22:44 To change this template use File | Settings | File Templates.
 */
...
public class TokenServiceTest {
	...
	public void shouldDelegateToTokenDao() {
		...
		verify(tokenDao).saveOrUpdate(token);
