...
INSERT INTO problem (problem_id,filePath,name, user_id) VALUES (2, 'ProblemContent 2', 'ProblemName 2', 1)
INSERT INTO problem (problem_id,filePath,name, user_id) VALUES (3, 'ProblemContent 3', 'ProblemName 3', 1)
...
--CREATE SUBMITS--
INSERT INTO submit ( submit_id, commit_date, file_name, exercise_id, result_id, user_id,submit_file, language) values (1, '2013-06-03 23:20:39.394', 'submit_name_2',1, 1, 1,null, 'language_1')
INSERT INTO submit ( submit_id, commit_date, file_name, exercise_id, result_id, user_id,submit_file, language) values (2, '2013-06-03 23:20:39.394', 'submit_name_2',1, 2, 2,null, 'language_2')
INSERT INTO submit ( submit_id, commit_date, file_name, exercise_id, result_id, user_id,submit_file, language) values (3, '2013-06-03 23:20:39.394', 'submit_name_3',1, 3, 1,null, 'language_3')
