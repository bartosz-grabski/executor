...
/**
 * @author bgrabski Class for handling register requests and responses
 */
@Controller
public class RegisterController {
	 ...
	 * 
	 * @param model
	 *            ModelMap to be filled and returned to the view
	 * @param request
	 *            HTTP POST request
	 ...
	 * 
	 * @param token
	 *            String token passed in link
	 * @param model
	 *            ModelMap returned to the view
	...
	private void sendMail(User u, String message, HttpServletRequest request) {
		...
		mailService.sendMail("from@from.pl", u.getEmail(), "AGH Online Judge Registration", request.getRequestURL().append("/").append(message).toString());
	 ...
	 * 
	 * @param request
	 *            HTTP Request with user data to be process
